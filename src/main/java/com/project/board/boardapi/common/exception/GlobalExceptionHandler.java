...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleInvalidCommentParent(InvalidCommentParentException e) {
        return buildDefaultResponseEntity(ErrorCode.INVALID_COMMENT_PARENT);
    }
